...
- [ ] **DD1-runtime — objetos/imports:** resolver VAs reais de
  ...
  avançou para 37 instruções com static_base (`AEEHelperFuncs`) suprido em `LB-4`, alcançando
  a chamada de serviço MALLOC via `bx r1` (`ldr r1, [r0, #0x68]` @ `0x1200218c`, branch @ `0x12002194`).
